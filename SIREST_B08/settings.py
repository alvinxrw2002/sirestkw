"""
Django settings for SIREST_B08 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-rkag=i@si&ro_bskc^jwb%2n#)@_14xuds!8t7kj40m%@#yvj^')
...
WSGI_APPLICATION = 'SIREST_B08.wsgi.application'
